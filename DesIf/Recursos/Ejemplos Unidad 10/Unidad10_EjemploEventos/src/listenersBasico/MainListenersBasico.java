...
IntegerProperty age = new SimpleIntegerProperty();
		...
		// CUIDADO. Si desde el listener se accede a observable sí que se notifica
		// Se añade un println antes de cada get o set para facilitar las pruebas y ver cuando se llama a los listeners
