...
public class MainController {
    ...
    public void mostrarListado() throws IOException {
        cargarVista("/com/example/practica01/vistas/ListadoView.fxml");
    }

    public void mostrarMantenimiento() throws IOException {
        cargarVista("/com/example/practica01/vistas/MantenimientoView.fxml");
    }

    public void mostrarTutorial() throws IOException {
        cargarVista("/com/example/practica01/vistas/TutorialView.fxml");
    }
