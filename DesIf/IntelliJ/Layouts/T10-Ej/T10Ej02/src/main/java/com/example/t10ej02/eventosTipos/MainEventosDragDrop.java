...
public class MainEventosDragDrop extends Application {
	...
	public void start(Stage primaryStage) {
		try {
	        ...
	        // OnDragDropped: Cuando se suelta el bot�n de rat�n al arrastrar el elemento en el destino
	        ...
	        // OnDragExited: Cuando el movimiento de rat�n ha finalizado
	        ...
	        // OnDragDone: Se notifica al elemento origen que ha finalizado la operaci�n de arrastrar y soltar
